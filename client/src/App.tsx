...
export default function App(){return <><InteractionRouter/><ThemeToggle/><FloatingCart/><Routes>
  ...
  <Route element={<CustomerGuard/>}><Route path="/customer" element={<CustomerOverview/>}/><Route path="/customer/pets" element={<CustomerFeature page="pets"/>}/><Route path="/customer/pets/new" element={<PetForm isNew/>}/><Route path="/customer/pets/:name" element={<PetDetail/>}/><Route path="/customer/pets/:name/edit" element={<PetForm/>}/><Route path="/customer/health" element={<CustomerFeature page="health"/>}/><Route path="/customer/journal" element={<CustomerFeature page="journal"/>}/><Route path="/customer/hotel" element={<CustomerHotelTracking/>}/><Route path="/customer/camera" element={<CustomerFeature page="camera"/>}/><Route path="/customer/payments" element={<CustomerFeature page="payments"/>}/><Route path="/customer/settings" element={<CustomerSettings/>}/></Route>
