...
export default function App(){return <><InteractionRouter/><ThemeToggle/><FloatingCart/><Routes>
  ...
  <Route path="/customer" element={<CustomerDashboard/>}/><Route path="/customer/pets" element={<CustomerFeature page="pets"/>}/><Route path="/customer/pets/new" element={<PetForm isNew/>}/><Route path="/customer/pets/:name" element={<PetDetail/>}/><Route path="/customer/pets/:name/edit" element={<PetForm/>}/><Route path="/customer/health" element={<CustomerFeature page="health"/>}/><Route path="/customer/journal" element={<CustomerFeature page="journal"/>}/><Route path="/customer/hotel" element={<CustomerHotelTracking/>}/><Route path="/customer/camera" element={<CustomerFeature page="camera"/>}/><Route path="/customer/payments" element={<CustomerFeature page="payments"/>}/><Route path="/customer/settings" element={<CustomerSettings/>}/>
  <Route path="/staff" element={<StaffDashboard/>}/>
  <Route path="/admin" element={<AdminDashboard/>}/><Route path="/admin/orders" element={<AdminOrders/>}/><Route path="/admin/hotel" element={<AdminHotelTracking/>}/><Route path="/admin/finance" element={<AdminFinance/>}/><Route path="/admin/expenses" element={<AdminExpenses/>}/><Route path="/admin/customers" element={<AdminEntities type="customers"/>}/><Route path="/admin/pets" element={<AdminEntities type="pets"/>}/><Route path="/admin/memberships" element={<AdminEntities type="memberships"/>}/><Route path="/admin/analytics" element={<AdminAnalytics/>}/><Route path="/admin/settings" element={<AdminSettings/>}/>
 </Routes></>}
