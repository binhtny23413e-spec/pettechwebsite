...
import { ArticleDetail, Knowledge, Membership, Pricing, ServiceDetail, Services } from './pages/PublicPages';
...
export default function App(){return <><InteractionRouter/><ThemeToggle/><Routes>
  ...
  <Route path="/booking" element={<Booking/>}/><Route path="/login" element={<Login/>}/><Route path="/register" element={<Login register/>}/>
